  ...
  <div className="flex flex-col justify-between rounded-xl border border-explorerBorder bg-articleBg p-6 shadow-sm transition-all hover:border-accentColor hover:shadow-md">
    <div className="min-w-0">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex shrink-0 gap-2 text-textSecondary">
          {repo.homepage && (
            <a
              href={repo.homepage}
              target="_blank"
      ...
      <p className="mt-3 line-clamp-3 text-sm text-textSecondary wrap-break-word">
        {repo.description || "No description provided."}
      </p>
    </div>

    <div className="mt-5 flex flex-wrap items-center justify-between gap-y-3 text-sm text-textSecondary">
