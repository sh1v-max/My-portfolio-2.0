      ...
      <div className="flex flex-1 flex-col gap-4 p-5 pt-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group/btn inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-accentColor px-4 py-2.5 text-sm font-semibold text-mainBg transition-all duration-300 hover:brightness-110 hover:shadow-lg active:scale-[0.97]"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group/btn inline-flex flex-1 items-center justify-center gap-2 rounded-lg border border-explorerBorder px-4 py-2.5 text-sm font-semibold text-textColor transition-all duration-300 hover:border-accentColor/50 hover:bg-accentColor/10 hover:text-accentColor active:scale-[0.97]"
          >
            <svg
